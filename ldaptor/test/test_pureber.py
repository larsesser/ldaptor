...
class BerLengths(unittest.TestCase):
    ...
    def testPartialBER(self):
        ...
        self.assertRaises(
            pureber.BERExceptionInsufficientData, pureber.berDecodeLength, m[:2]
        )
        self.assertRaises(
...
class BERBooleanKnownValues(unittest.TestCase):
    knownValues = (
        (0, [0x01, 0x01, 0], False),
        (1, [0x01, 0x01, 0xFF], True),
        (2, [0x01, 0x01, 0xFF], True),
        (125, [0x01, 0x01, 0xFF], True),
        (126, [0x01, 0x01, 0xFF], True),
        (127, [0x01, 0x01, 0xFF], True),
        (-1, [0x01, 0x01, 0xFF], True),
        (-2, [0x01, 0x01, 0xFF], True),
        (-3, [0x01, 0x01, 0xFF], True),
        (-126, [0x01, 0x01, 0xFF], True),
        (-127, [0x01, 0x01, 0xFF], True),
        (-128, [0x01, 0x01, 0xFF], True),
        (-129, [0x01, 0x01, 0xFF], True),
        (-9999, [0x01, 0x01, 0xFF], True),
        (128, [0x01, 0x01, 0xFF], True),
        (255, [0x01, 0x01, 0xFF], True),
        (256, [0x01, 0x01, 0xFF], True),
        (9999, [0x01, 0x01, 0xFF], True),
    )
